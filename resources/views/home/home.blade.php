...
@section('main')
<div class="h-full mx-auto max-w-7xl sm:px-6 lg:px-8 my-30 ">
    <div
        class="mt-40 relative isolate overflow-hidden bg-white px-6 py-20 text-center sm:px-16 sm:shadow-sm">
        <p class="mx-auto max-w-2xl text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            तपाईलाई चाहिने पुस्तक खोज्नुहोस् ?
        </p>
        ...
        <form action="/search">
            <label
                ...
                <input id="search-bar" placeholder="your keyword here" name="q"
                    class="px-6 py-2 w-full rounded-md text-black flex-1 outline-none bg-white" required="">
                <button type="submit"
